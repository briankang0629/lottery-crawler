...
const POWER_LOTTERY_URL = 'lto/list.asp';
...
exports.history = async (req, res, next) => {
    ...
    const rs = await axios.get(TAIWAN_LOTTERY_URL + POWER_LOTTERY_URL);
    const DOM = rs.data;
    ...
    while (page <= totalPage) {
        const rs = await axios.get(TAIWAN_LOTTERY_URL + POWER_LOTTERY_URL + '?indexpage=' + page);
        const DOM = rs.data;
        const $ = cheerio.load(DOM);
